...
import com.v2ray.core.proxy.vless.account
import com.v2ray.core.proxy.vless.outbound.config
...
fun VLESSBean.buildProxySettings() = letTyped {
    config {
        vnext.add(asEndpoint(typedMessage {
            account {
                id = uuidOrGenerate()
